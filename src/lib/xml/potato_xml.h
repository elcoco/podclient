...
#define PP_CHAR_TAG_START      "<"
#define PP_CHAR_TAG_END        ">"
...
struct PPParserEntry {
    const char *start;
    const char *end;
    void(*cb)(struct PP *pp, struct PPParserEntry *pe, enum PPParserEvent ev, void *user_data);
    //void(*cb)(struct PXML *xml, struct PXMLParserEntry *pe, enum PXMLParserEvent ev, void *user_data);
    //entry_cb cb;
...
typedef void(*entry_cb)(struct PP *pp, struct PPParserEntry *pe, enum PPParserEvent ev, void *user_data);
typedef void(*handle_data_cb)(struct PP *pp, enum PPEvent ev, void *user_data);

struct PP pp_xml_init(void(*handle_data_cb)(struct PP *pp, enum PPEvent ev, void *user_data));
void pp_handle_data_cb(struct PP *pp, enum PPEvent ev, void *user_data);
